...
const relation ={justifyContent: 'flex-end', }
const Footer = () => {
  return (
    <Column fd='row' p={10} bgcolor='#0d1e2d' fw='wrap' jc='flex-end'>
      ...
      <Column minw={125} mh={'1%'} ai='center' col1={topCol} col2={topCol} >
        <Column minw={125} h={53} fd='row' jc='flex-end'>
        ...
        <Row mt={8} ai='center' >
            <P minw={35} color='white'>ایمیل: </P><Pfa fs={14} mb={-3} minw={125} f={1} color='white' >email@email.com</Pfa>
          </Row>

          <Row mt={8} ai='center' >
            <P color='white'>تماس: </P><Pfa mb={-2} color='white'>  090999999</Pfa>
          </Row>
